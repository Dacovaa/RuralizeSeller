...
public class ProfileFragment extends Fragment {
    ...
    private void inicializarComponentes(View view) {
        // TextInputLayouts
        tilEmpresa = view.findViewById(R.id.tilEmpresa);
        tilCnpj = view.findViewById(R.id.tilCnpj);
        ...
        txtDataCadastro = view.findViewById(R.id.txtDataCadastro);
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    try {
                        ...
                        String cnpj = json.optString("cnpj", "");
                        String email = json.optString("email", "");
                        JSONObject dataCadastro = json.optJSONObject("createdAt");
    ...
    private void abrirAlteracaoSenha() {
        ...
        View dialogView = LayoutInflater.from(requireContext()).inflate(R.layout.dialog_alterar_senha, null);
    ...
    private void validarEAlterarSenha(String senhaAtual, String novaSenha, String confirmarSenha) {
        ...
        if (senhaAtual.isEmpty()) {
            Toast.makeText(requireContext(), "Digite sua senha atual", Toast.LENGTH_SHORT).show();
            return;
        }

        if (novaSenha.isEmpty()) {
            Toast.makeText(requireContext(), "Digite a nova senha", Toast.LENGTH_SHORT).show();
            return;
        }
